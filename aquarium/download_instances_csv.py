...
async def csvTable(q: Q):
    ...
    columns = [
        ...
        ui.table_column(name='email', label='email', sortable=True, searchable=True, filterable=True),
        ui.table_column(name='title', label='title', sortable=True, searchable=True, filterable=True),
    ...
    rowsInfo = [
        Row(
            ...
            cloudCost = str(df.loc[i].at["cloudCost"])) for i in range(20)
    ]
